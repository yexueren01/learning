...
import com.twogrit.learning.java8.annotation.simple.Author;
import com.twogrit.learning.java8.annotation.simple.Description;
...
public class UtilityTest {
    ...
    public void test() throws ClassNotFoundException, NoSuchMethodException {
        ...
        Class rt_class = Class.forName("com.twogrit.learning.java8.annotation.simple.Utility");
